enum RequestFunc {
  ...
  CHECKFRIENDEXISTS = "checkFriendExists",
  ADDFRIENDTOBALCK = "AddFriendToBlack",
  GETSPECIFIEDFRIENDINFO = "GETSPECIFIEDFRIENDINFO",
